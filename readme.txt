...
= Varktech.com Hosted Documentation Provided =
In the plugin, there is hover-based documentation in the Add Rule screen.
There are also documentation panels which refer back to the Varktech.com documentation pages.
...
= 2.0.3.2 - 2022-10-08 =
* Fix - Cart deal discount type - by default supplies crossouts in the cart, checkout and emails. 
        In rare cases, the crossout was not supplied. This fix repairs this issue. 
* Enhancement  - Changed Pro update nag to have full message on plugins page


= 2.0.3.1 - 2022-09-28 =
* Fix - For version control only

= 2.0.3 - 2022-09-23 =
* Fix - tech requirements from Wordpress Plugin Team - major overhaul required.  
          	- all server and temp storage input, user input and output, to be sanitized/escaped.
			- All DB access to use 'prepare'.
			- all js and css produced during execution to use the inline function 
...
= 2.0.2.02 - 2021-02-07 =
* Fix - remove no-cache on header statement in sessions
          	- Session management update throughout with write_closes
* Fix - Woo 5.0 changes - Session being cleared by Woo too early, 
        causing crossout and other processing issues: 
          	- cart and checkout pages when showing discount in unit price
          	- also show old price crossout on checkout page, thankyou page and emails
          	- now storing session array in new transient row by IP
* Fix - when discount shown as coupon, discount amount was not carrying through to coupon 
