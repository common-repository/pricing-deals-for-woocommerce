...
function vtprd_license_options_cntl() {
    ...
    //v2.0.3 begin - recoded to handle sanitize
    ...
    //$action =   sanitize_text_field($action); //v2.0.3 
    //v2.0.3 end
 ...
 */   
  ...
  ?>
    ...
    <?php 
      ...
      //v2.0.3 BEGIN
      //inline messages changed to be able to use wp_kses
      if ($vtprd_license_options['expires'] > ' ') {
        if ($vtprd_license_options['expires'] == 'lifetime') {
          if ($vtprd_license_options['prod_or_test'] == 'demo') {
            ?> <p id="license-expiry-msg"><?php echo wp_kses($item_name ,$allowed_html ); ?> - 3-Day License </p> <?php
            
            $message  =  '<p id="license-expiry-msg">' .$item_name. ' - 3-Day License </p>';
          
          } else {
            $message  =  '<p id="license-expiry-msg">' .$item_name. ' - Lifetime License </p>';
          }             
        } else {
          $message  =  '<h2 id="license-expiry-msg" style="font-size: 1.5em;"><em>' .$item_name. ' - - License Expires:: '.$vtprd_license_options['expires'].'</em> </h2>' ;
        } 
    ...
    ?>
              ...
              if ($pro_plugin_is_installed) {
               // $url = bloginfo('url'); v1.1.6 does crazy stuff in wp-admin!!
                $message =
                   '<br><br><br>
                   <h3 class="red">
                        <strong> - Activate the &nbsp;&nbsp;<em>';
                $message .=  $item_name; 
                $homeURL = VTPRD_ADMIN_URL.'plugins.php';
                $message .=  '</em> &nbsp;&nbsp;  on the &nbsp;&nbsp; <a href="'.esc_url($homeURL).'">Plugins page</a> &nbsp;&nbsp; - to show a Registration Button here.'; // v1.1.8.2  removed home_url 
                $message .=  '</strong></h3>'; 
              } else {  //PRO not currently installed
                $message =
                   '<br><br><br>
                   <h3 class="yellow">';
                $message .=  ' - You have installed and activated the FREE version of the plugin only.  <br><br>Please &nbsp;<strong>also</strong>&nbsp; Install and Activate the  &nbsp;&nbsp;<em>';  //v1.1.7.2 wording changed
                $message .=  $item_name;  
                $message .=  '</em> &nbsp;&nbsp; to show a Registration Button here. </h3>';               
              }
     ...
     <?php //v1.1.8.2  re-coded begin  ?>
      ...
      <br><br>
        <div class="pricing-deal-example group" id="pricing-deal-example-2">                     
          <p class="title">                                                                      
            <a class="title-anchor title-anchor-plus"  id="title-anchor-plus-2"   href="<?php echo esc_js('javascript:void(0);');?>"> 
              <span class="title-text">How to Transfer PROD or TEST registration from one site to another
              </span>
              <span class="plus-icon">+
              </span> </a>            
            <a class="title-anchor title-anchor-minus" id="title-anchor-minus-2"  href="<?php echo esc_js('javascript:void(0);');?>"> 
              <span class="title-text">How to Transfer PROD or TEST  registration from one site to another
              </span>
        ...
        <br><br>&nbsp;&nbsp; 2. *Activate* the license in the Second Site
         ...
         <div class="pricing-deal-example group" id="pricing-deal-example-1">                     
          <p class="title">                                                                      
            <a class="title-anchor title-anchor-plus"  id="title-anchor-plus-1"   href="<?php echo esc_js('javascript:void(0);');?>"> 
              <span class="title-text">Test Site Registration OPTIONS
              </span>
              <span class="plus-icon">+
              </span> </a>            
            <a class="title-anchor title-anchor-minus" id="title-anchor-minus-1"  href="<?php echo esc_js('javascript:void(0);');?>"> 
              <span class="title-text">Test Site Registration OPTIONS
              </span>
              <span class="minus-icon">-
              </span> </a>          
     ...
     <?php //v1.1.8.2 end ?>    
        ...
        <br>
        <a id="show-info-button" href="<?php echo esc_js('javascript:void(0);');?>" >
        <span> <?php esc_attr_e('Show Licensing Info', 'vtprd'); ?> </span></a>
        <br><br>
  
        <div id="show-licensing-info">
          <p style="font-size: 15px;font-weight: bold;color: #2271b1;" >To copy the system info, click below then press Ctrl + C &nbsp;&nbsp; (or Cmd + C for a Mac).</p>
          <?php
            ...
            */
            ...
            //readonly="readonly" onclick="this.focus(); this.select();"  id="system-info-textarea" 
           ...
           */           
           ...
           <textarea 
                style="
                  ...
                  display: block;
                "           
           readonly="readonly" class= "textarea-focus" id="system-info-textarea" 
           name="edd-sysinfo" title="To copy the system info, click below then press Ctrl + C (PC) or Cmd + C (Mac)."><?php echo wp_kses(vtprd_return_license_info() ,$allowed_html ); ?></textarea>
...
function vtprd_set_default_options() {
     ...
     $url = esc_url( home_url() ); //SET URL     
     $url_no_http = vtprd_strip_out_http($url); //v2.0.3.2 moved to functions.php 
      ...
      case 'unregistered' :
          ...
          ?>                                   
            <h4 id="vtprd-license-messaging">
                  <strong><?php esc_attr_e('Pro Plugin License Activation', 'vtprd'); ?></strong> 
            </h4> 
          <?php 
          } else {
          ...
          ?>                                   
            <h4 id="vtprd-license-messaging">
                  <strong><?php esc_attr_e('Varktech Registration Process busy.  Please try again. If it does not work a second time, please click on "Clear Licensing Info" and try again.', 'vtprd'); ?></strong> 
            </h4> 
          <?php           
          } 
        break; 
      ...
      case 'valid'  :     
          ...
          if ( ( isset($vtprd_license_options['last_response_from_host']) ) &&
              ...
              if ( ( isset($vtprd_license_options['last_response_from_host']['response']['code']) )
                ...
                $homeURL = 'https://www.varktech.com/support';
                $vtprd_license_options['msg'] = 'Activation request temporarily blocked by Varktech security. Please click "Show Licensing Info", copy info. Contact <a href="' .esc_url($homeURL). '"  title="Support">VarkTech Support</a>, paste copied information into email.';       
              }  
           }        
          $message =  '<h2 id="vtprd-license-messaging" style="color: green !important;" ><strong>'  .$vtprd_license_options['msg']. '</strong></h2>';  //v2.0.3 
          $allowed_html = vtprd_get_allowed_html(); //v2.0.3
          echo wp_kses($message ,$allowed_html ); //v2.0.3        
        break;
          ...
          switch ( $vtprd_license_options['state'] ) { 
              ...
              case ($vtprd_license_options['state'] == 'pending')  :
                 ...
                 if ($vtprd_license_options['diagnostic_msg'] == 'demo_license_expired') {
                    //v2.0.3 BEGIN
                    $message =                                   
                      '<h2 id="vtprd-license-messaging" style="color: red !important;" ><strong>' .$vtprd_license_options['msg']. '</strong></h2>'; 
                    $message .=
                      '<h2 id="vtprd-license-messaging" style="color: red !important;" >
                            <strong>Please  <a  href="' .esc_url(VTPRD_PURCHASE_PRO_VERSION_BY_PARENT). '"  title="Please purchase a full license!">'
                            . esc_attr_e('Purchase an Unlimited Pro License', 'vtprd') . '</a> ! </strong></h2>';                                       
                    $allowed_html = vtprd_get_allowed_html(); //v2.0.3
                    echo wp_kses($message ,$allowed_html ); //v2.0.3 
                    //v2.0.3 END                
                    return;
                 ...
                 if ($vtprd_license_options['strikes'] > 0) {
                    ...
                    if ($tries_left == 1) {
                      ...
                      $message =                                   
                            '<h2 id="vtprd-license-messaging" style="color: red !important;" >
                            <strong>' .$vtprd_license_options['msg']. '</strong><br><br> 
                            <strong>You have ' .$tries_left. $tries_left_msg. '</strong>
                            </h2>'; 
                        $allowed_html = vtprd_get_allowed_html(); //v2.0.3
                        echo wp_kses($message ,$allowed_html ); //v2.0.3  
                       //v2.0.3 END 
                    if ($tries_left == 1) {
                      //v2.0.3 BEGIN
                        $message =                                   
                            '<h2 class="red"><strong>If you make a mistake with your last try, the License will be Suspended for ALL SITES using this license</strong>
                            </h2>'; 
                        $allowed_html = vtprd_get_allowed_html(); //v2.0.3
                        echo wp_kses($message ,$allowed_html ); //v2.0.3  
                      //v2.0.3 END 
              ...
              case ($vtprd_license_options['state'] == 'suspended-by-vendor')  :
                      //v2.0.3 BEGIN
                      $message = '<h2 id="vtprd-license-messaging" style="color: red !important;"><strong>' .$vtprd_license_options['msg']. '</strong></h2>'; 
                      $allowed_html = vtprd_get_allowed_html(); //v2.0.3
                      echo wp_kses($message ,$allowed_html ); //v2.0.3  
                      //v2.0.3 END 
                break;            
  ...
  *********************************************************    
   ...
   */
    ...
    //strip out leading/trailing spaces
		...
		$license        = trim( $input['key']  ?? '' );      //v2.0.3 added  ?? '' 
    //move trimmed value back
    $input['key']   = $license; 
    
    $email          = trim( $input['email']  ?? '' );       //v2.0.3 added  ?? '' 
    //move trimmed value back
    $input['email'] = $email; 
    //v1.1.6.7 end
  ...
  public function vtprd_enqueue_setup_scripts($hook_suffix) {
    ...
    switch( $hook_suffix) {        //weird but true
      case 'vtprd-rule_page_vtprd_license_options_page':                
        $allowed_html = vtprd_get_allowed_html(); //v2.0.3
        $homeURL = VTPRD_URL.'/admin/css/vtprd-admin-style-' .wp_kses(VTPRD_ADMIN_CSS_FILE_VERSION ,$allowed_html). '.css';
        wp_register_style('vtprd-admin-style', esc_url($homeURL) );  //v1.1.0.7
        wp_enqueue_style ('vtprd-admin-style');
        $homeURL = VTPRD_URL.'/admin/css/vtprd-admin-settings-style.css';
        wp_register_style('vtprd-admin-settings-style', esc_url($homeURL) );  
        wp_enqueue_style ('vtprd-admin-settings-style'); 
        
        //***************
        //v2.0.3 begin
        $homeURL = VTPRD_URL.'/admin/css/vtprd-admin-license-style.css';
        wp_register_style('vtprd-admin-license-style', esc_url($homeURL) );        
        wp_enqueue_style ('vtprd-admin-license-style'); 
        $homeURL = VTPRD_URL.'/admin/js/vtprd-admin-license-script.js';  
        wp_register_script('vtprd-admin-license-script', esc_url($homeURL) );  
        wp_enqueue_script ('vtprd-admin-license-script', array('jquery'), false, true);  
        //v2.0.3 end 
        //***************  
      break;
    }
 ...
 */ 
    ...
    //v2.0.3 changed to add sanitize below
    $settings_error = false;
    if (isset($new_combined_options['key'])) {    
        $new_combined_options['key'] = sanitize_text_field($new_combined_options['key']);
    } else {
        $new_combined_options['key'] = null;
    }
    
    if ($new_combined_options['key'] > ' ')  {
      $carry_on = true;    
    } else {
    ...
    if (isset($new_combined_options['email'])) {    
        $new_combined_options['email'] = sanitize_email($new_combined_options['email']);
    } else {
        $new_combined_options['email'] = null;
    }    
    
    if ($new_combined_options['email'] > ' ') {
      $carry_on = true;    
    } else {
    ...
    $new_combined_options['prod_or_test'] = vtprd_sanitize_text_or_array_field($_REQUEST['prod_or_test']);
    
    //v2.0.3 added supply default...
    if ($new_combined_options['prod_or_test'] > ' ') {
      $carry_on = true;    
    } else {
      $new_combined_options['prod_or_test'] = 'prod';  
    }  
...
//TEST    $new_combined_options['msg'] = 'License Activated';
  ...
  //v2.0.3.2 moved to functions.php
  /*
  //from http://stackoverflow.com/questions/15699101/get-client-ip-address-using-php
  public  function  vtprd_strip_out_http($url) {
        //error_log( print_r(  'vtprd_strip_out_http begin $url= ' .$url, true ) );
   
      $url = str_replace( 'https://', '', $url  ?? '' ) ;     //v2.0.3 added  ?? '' 
      $url = str_replace( 'http://', '', $url  ?? '' ) ;      //v2.0.3 added  ?? '' 
      $url = rtrim($url, "/"  ?? ''  ); //remove trailing slash       //v2.0.3 added  ?? '' 
            
        //error_log( print_r(  'vtprd_strip_out_http end $url= ' .$url, true ) );
...
//v1.1.6.3  Activated!! Now set to run a max of 2x per day, ecept when manually demanded via vtprd_force_plugin_updates_check
      ...
      //error_log( print_r(  'Updater date difference (looking for > 39600) = ' . ($today - $last_updater_check_ts) , true ) ); 
        ...
        if ($pro_plugin_is_installed) {
           //error_log( print_r(  'vtprd_maybe_exec_plugin_updater Pro plugin installed, above updater check, VERSION = ' .$version, true ) );        
        	...
        	// setup the updater
        	$store_url = esc_url(VTPRD_STORE_URL);  //v2.0.3
            $edd_updater = new VTPRD_Plugin_Updater( $store_url, __FILE__, array(
  ...
  function  vtprd_maybe_license_state_message() { 
     //error_log( print_r(  'Begin vtprd_maybe_license_state_message', true ) );
      ...
      if (!$pro_plugin_is_installed) {
        //v2.0.3 begin
        if ($vtprd_license_options['state'] == 'suspended-by-vendor') {
          $message = '<p class="yellow" id="license-status-msg"><strong>Pro Plugin ** not installed **, no action required.  <br><br> However, license was previously suspended by vendor </strong></p>'; 
          $message .= '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
          $message .= '<a  href="' .esc_url(VTPRD_PURCHASE_PRO_VERSION_BY_PARENT). '"  title="Purchase a full Pro license">Purchase a full Pro license</a>';
        } else {
          $message = '<p class="green" id="license-status-msg"><strong>Pro Plugin not installed, no action required.<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
          $message .= '<a  href="' .esc_url(VTPRD_PURCHASE_PRO_VERSION_BY_PARENT). '"  title="Purchase a full Pro license">Purchase a full Pro license</a>'; 
        }
        $message .= '</strong></p><br>';
        $allowed_html = vtprd_get_allowed_html(); //v2.0.3
  ...
  */       
  ...
  // //error_log( var_export($vtprd_license_options, true ) );        
      ...
      if ( ( isset($vtprd_license_options['last_response_from_host']) ) &&
        ...
        if ( ( isset($vtprd_license_options['last_response_from_host']['response']['code']) )
            ...
            ( ($vtprd_license_options['last_response_from_host']['response']['code'] == '403' ) ||
             ($vtprd_license_options['last_response_from_host']['response']['code'] == '500' ) ) ) {
          $homeURL = 'https://www.varktech.com/support';
          ?> <p class="red" id="license-status-msg"><strong>Activation request temporarily blocked by Varktech security. Please click "Show Licensing Info", copy info. Contact <a href="<?php esc_url($homeURL); ?>"  title="Support">VarkTech Support</a>, paste copied information into email.</strong></p> 
          <?php
          return;
        } 
      }
      ...
      if ($vtprd_license_options['status'] == 'valid') {   
          switch ( $vtprd_license_options['state'] ) { 
            case 'active' : 
                if ( ($vtprd_license_options['last_action'] == 'activate_license') ||
                  ...
                  ?> <p class="green" id="license-status-msg"><strong><em> Activated Successfully! </em> </strong></p> <?php    
                  
                 // v1.1.6 ON HOLD vtprd_show_update_check_button(); //v1.1.6
                  
                } else { //tried to deactivate
                  ?> <p class="red" id="license-status-msg"><strong>Deactivation failed, please try again! </strong></p> <?php 
                }
            ...
            case 'deactivated' : 
                if ( ($vtprd_license_options['last_action'] == 'deactivate_license') ||
                     ($vtprd_license_options['last_action'] == 'check_license') ) {
                  ?> <p class="green" id="license-status-msg"><strong><em> Deactivated Successfully! </em> </strong>
                     &nbsp;&nbsp;&nbsp;<span class="smallGreyText"> (Pro Plugin will not function until activated)</span>
                     </p>                  
                  <?php    
                } else { //tried to activate
                  ?> <p class="green" id="license-status-msg"><strong>Activation failed, please try again! </strong></p> <?php 
                }
              break;                    
         ...
         switch ( $vtprd_license_options['state'] ) {  
          case 'unregistered' : 
              if ($vtprd_license_options['last_action'] > ' ') {
                ?> <p class="red" id="license-status-msg"><strong>Failed to Connect to Host.  Please Try Again. </strong></p> <?php
                ...
                ?> <p class="yellow" id="license-status-msg"><strong>License key registration required -  Pro Plugin will not function until registered. </strong>
                    ...
                    <?php                     
                      ...
                      $message .=  '</strong>';
                      $homeURL = 'https://www.varktech.com';
                      $message .=  '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . __('- If you do not have either ID, Go to <a href="' .esc_url($homeURL). '">Varktech</a>', 'vtprd') ;
                      ...
                      $homeURL = 'https://www.varktech.com/your-account/license-lookup/';
                      $message .=  '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'     . __('- by Name and Email Address', 'vtprd') .'&nbsp;&nbsp;&nbsp; <a href="' .esc_url($homeURL). '">License Key Lookup by Name and Email</a>' ;                                           
                      $allowed_html = vtprd_get_allowed_html(); //v2.0.3
                      echo wp_kses($message ,$allowed_html ); //v2.0.3                
                     ?>            
                  </p> <?php
          ...
          case 'pending' :
              switch ( $vtprd_license_options['last_action'] ) {  
                  case 'activate_license' :
                  case 'check_license' :
                      $message = '<p class="yellow" id="license-status-msg" style="font-size:12px;"><strong>' . VTPRD_ITEM_NAME . $prod_or_test; 'is in a Pending Activation state. <br><br> Please edit the Licensing Information and then activate. </strong></p>';
                      $allowed_html = vtprd_get_allowed_html(); //v2.0.3
                      echo wp_kses($message ,$allowed_html ); //v2.0.3                      
                     break;
                  case 'deactivate_license' :
                      $message = '<p class="yellow" id="license-status-msg" style="font-size:12px;"><strong>' . VTPRD_ITEM_NAME . $prod_or_test; 'is in a Pending Deactivation state. <br><br> Please edit the Licensing Information and then deactivate. </strong></p>';
                      $allowed_html = vtprd_get_allowed_html(); //v2.0.3
                      echo wp_kses($message ,$allowed_html ); //v2.0.3                      
                     break;                             
              }
  ...
  function  vtprd_demo_license_expired_message() { 
    ...
    global $vtprd_license_options;
    //v2.0.3 begin
    $message  = '<p class="yellow" id="license-status-msg"><strong>&nbsp;&nbsp;&nbsp;   3-Day Demo license has expired.<br><br>&nbsp;&nbsp;&nbsp;';
    $message .= '<a  href="' .esc_url(VTPRD_PURCHASE_PRO_VERSION_BY_PARENT). '"  title="Purchase a full Pro license:">Purchase a full Pro license</a>' ;
    $message .= '
  ...
  function  vtprd_license_suspended_message() { 
    ...
    ?> <p class="red" id="license-status-msg"><strong>
        ...
        <br>&nbsp;&nbsp;&nbsp;
        <?php 
        $message = VTPRD_ITEM_NAME; //v2.0.3 
        $allowed_html = vtprd_get_allowed_html(); //v2.0.3
        echo wp_kses($message ,$allowed_html ); //v2.0.3
        $homeURL = 'https://www.varktech.com/support';
        ?> 
        ...
        <br><br>&nbsp;&nbsp;&nbsp; For Assistance, Please contact <a  href="<?php esc_url($homeURL); ?>"  title="Support">www.varktech.com/support</a> and supply the following Information: 
        </span>
  ...
  function vtprd_maybe_delete_pro_plugin_action() {
      ...
      //$pageURL = $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"];  //v2.0.3
      $pageURL  = sanitize_url($_SERVER["SERVER_NAME"]); //v2.0.3
